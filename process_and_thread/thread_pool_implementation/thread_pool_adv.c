...
void SumandProduct(int a, int b){
    /* Simple Function to calculate sum and product of two random numbers */
    int sum = a + b;
    int product = a * b;
    printf("The sum and product of %d and %d are %d and %d respectively.\n", a, b, sum, product);
}
...
int main(){
   ...
   for(i = 0; i < THREAD_NUM; i++){
    ...
    for(i = 0; i < 100; i++){
        Task t = { .taskFunction = &SumandProduct,
        .arg1 = rand() % 100,
        .arg2 = rand() % 100
        };
        submitTask(t);
